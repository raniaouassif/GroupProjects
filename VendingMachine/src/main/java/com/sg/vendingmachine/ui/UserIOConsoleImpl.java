...
public class UserIOConsoleImpl implements UserIO {
     ...
     *
     * A simple method that takes in a message to display on the console,
     * and then waits for a non empty answer from the user to return.
     *
     * @param msgPrompt - String explaining what information you want from the user.
     * @return the answer to the message as string
     */
     ...
     *
     * A simple method that takes in a message to display on the console,
     * and then waits for a formatted answer from the user to return.
     *
     * @param msgPrompt - String explaining what information you want from the user.
     * @param regex - String regex that the user answer should match
     * @return the answer to the message as string
     */
    @Override
    public String readFormattedString(String msgPrompt, String regex) {
        String userIn;
        do {
            userIn = readString(msgPrompt);
        } while (!userIn.matches(regex));
        return userIn;
    }
